...
CONTAINS
    ...
    SUBROUTINE InitGrid(this, ut, un, n_a, sf, n_b, n_c, n_dust, egy_lvl)
        ...
        this%co_mx_b(:)           = 0.0_r2
        this%co_mx_c(:)           = 0.0_r2
        this%cell_vol(:)          = 1.0e-200_r2
        this%cell_minA(:)         = 1.0e-30
        this%cell_gauss_a(:)      = 1.0e-30_r2
        this%cell_gauss_a2(:)     = 1.0e-30_r2
        this%cellmidcaco(:,:)     = 0.0_r2
        this%ddust(:)             = 1.0e-200_r2
        this%Nv(:,:)              = 1.0e-200_r2
        this%Nv_mol(:)            = 1.0e-200_r2
        this%Nv_col(:,:)          = 1.0e-200_r2
        this%grd_dust_density(:,:)= 1.0e-200_r2
        this%grd_col_density(:,:) = 1.0e-200_r2
        this%grd_mol_density(:)   = 1.0e-200_r2
        this%velo(:,:)            = 1.0e-30
        this%absvelo(:)           = 1.0e-30
        this%cell_idx2nr(:,:,:)   = 0
        this%cell_nr2idx(:,:)     = 0
        this%t_dust(:,:)          = 1.0e-30_r2
        this%t_gas(:)             = 1.0e-30_r2
        this%d_l_min              = 0.0_r2
        this%cell_energy(:,:)     = 1.0e-200_r2
        this%lvl_pop(:,:)         = 1.0e-30
        this%counter              = 0
