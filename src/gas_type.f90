...
CONTAINS
    ...
    SUBROUTINE InitGas(this, ut, un, moldustratio, nvratio, n_tr, tr_cat, i_vel_chan, vel_max)
        IMPLICIT NONE
        !------------------------------------------------------------------------!
        TYPE(Gas_TYP)                      :: this
...
!~         DO i = 0, 400
!~             this%gaussian_x(i)  = i*6.0_r2/400
!~             this%gaussian(i)    = exp(-(i*6.0_r2/400)**2)
!~         END DO
        DO vch = -this%i_vel_chan,this%i_vel_chan  
            this%velo_channel(vch) = this%vel_max*real(vch,kind=r2)/REAL(this%i_vel_chan,kind=r2)
        END DO
...
!~         INTEGER                      :: col_id
        ...
        DO i = 1, this%trans_lvl
            ...
            read(unit=1,fmt=*)  waste_i, this%trans_upper(i), this%trans_lower(i), &
                                this%trans_einstA(i), this%trans_freq(i), this%trans_inneregy(i)
                                
            this%trans_freq(i) =  this%trans_freq(i)*1e9_r2  
            
            
            ! calculate einstein B _u(pper), _l(ower) levels
            this%trans_einstB_u(i) = this%trans_einstA(i) * (con_c/(this%trans_freq(i)))**2 / &
                                     (2.0_r2*con_h*(this%trans_freq(i)))
                                     
            this%trans_einstB_l(i) = this%g_level(this%trans_upper(i))/this%g_level(this%trans_lower(i)) &
                                     * this%trans_einstB_u(i)
        END DO
        !tbd!~! read collisions and other stuff from file not needed for LTE level populations
        ...
        DO k = 1, this%col_partner
            ...
            DO i = 1, this%col_trans
                READ(unit=1,fmt=*) waste_i, this%col_upper(i,this%col_id(k)), this%col_lower(i,this%col_id(k)),&
                                   this%col_colmatrix(this%col_id(k),i,:)
                this%col_colmatrix(this%col_id(k),i,:) = this%col_colmatrix(this%col_id(k),i,:)*1.0e-6_r2
            END DO
